...
<!-- 가장 메인 -->
    ...
    <div class="my_page_title">My Page</div>
    ...
    <div class="sidebar">
        <div class="menu_item selected" data-target="Like/like.jsp">관심 업체</div>
        <div class="menu_item" data-target="chat/chat.jsp">채팅방</div>
        <div class="menu_item" data-target="calendar/calendar.html">캘린더</div>
        <div class="menu_item" data-target="mywriting/mywriting.html">내가 쓴 글</div>
        <div class="menu_item" data-target="setting/setting.jsp">개인정보</div> <!-- 개인정보 메뉴 추가 -->
    </div>
    <div class="content">
